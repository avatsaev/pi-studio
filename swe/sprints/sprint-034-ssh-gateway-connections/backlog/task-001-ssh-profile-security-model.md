...
- `swe/architecture/ssh-gateway-connections.md` § Public Contract, § Data & Persistence,
  § Credential handling, § Host key verification
- `swe/architecture/client-app-runtime.md` § App runtime concepts, § Connection
- `swe/features/desktop-app.md` § Bridge capabilities
