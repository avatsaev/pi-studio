...
protocol/server scope** in `swe/sprints/PLAN.md` (Open questions). Until this exists,
the Provider Usage settings section and the composer-footer usage widget can only show mocked data.

## Scope references
- `swe/features/provider-usage.md`
- `swe/architecture/websocket-protocol.md` (append-only conventions)
- `swe/architecture/structured-generation.md`
