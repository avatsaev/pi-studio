 ...
 *
 * Entries may be direct daemon addresses or pairing links. The connection layer resolves
 * pairing links to direct-host or E2EE relay transports when the user connects.
 */
...
export interface SavedServer {
  id: string;
  name: string;
  /** Daemon address or pairing link accepted by `resolveConnectTarget`. */
  url: string;
  /**
