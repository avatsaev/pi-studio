...
- **Status:** backlog
- **Estimated size:** M
- **Depends on:** task-001; task-004 (sprint-012, subagents track logic)
...
## Out of scope
- Explorer/preview (tasks 001–002). Git (task-003). Terminal (task-004). Subagents-track logic + cascade
  policy (sprint-012/task-004 — consumed here). Service-proxy server (sprint-009).
