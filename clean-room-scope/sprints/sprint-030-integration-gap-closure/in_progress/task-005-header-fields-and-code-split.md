...
## Scope references
- `clean-room-scope/features/workspace-ui.md` § header
- `clean-room-scope/features/service-proxy.md` (scripts count / setup availability)
- `clean-room-scope/architecture/client-app-runtime.md` § electron marker (`getIsElectron()`)
