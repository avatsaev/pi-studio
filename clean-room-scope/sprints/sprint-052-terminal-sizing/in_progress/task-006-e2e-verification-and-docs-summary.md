...
- `clean-room-scope/features/terminals.md` — § PTY size ownership rewritten to the authority model,
...
- `clean-room-scope/features/feature-panels-ui.md` — the contradicting contract block rewritten (C2);
