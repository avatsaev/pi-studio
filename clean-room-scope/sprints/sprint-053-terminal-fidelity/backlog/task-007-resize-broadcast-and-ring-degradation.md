...
`clean-room-scope/features/terminals.md` § PTY size ownership and § Restore / snapshot. This task
removes them.
...
## Scope references
- `clean-room-scope/features/terminals.md` § PTY size ownership (the "known limitation of multi-client
...
- `clean-room-scope/sprints/sprint-053-terminal-fidelity/backlog/task-003-exited-terminal-state.md` —
