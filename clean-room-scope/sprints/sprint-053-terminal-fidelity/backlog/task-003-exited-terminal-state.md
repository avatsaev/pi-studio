...
## Scope references
- `clean-room-scope/features/feature-panels-ui.md` § Terminal pane → Streaming ("exit sets 'Terminal
  exited'"), § States, § Error Handling & Edge Cases (`PTY exits`)
- `clean-room-scope/features/terminals.md` § Behavior (`kill(slot)`: "terminate PTY; notify
