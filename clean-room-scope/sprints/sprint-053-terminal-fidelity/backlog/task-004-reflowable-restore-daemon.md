...
## Scope references
- `clean-room-scope/features/terminals.md` § Restore / snapshot (tier 2), § Binary stream protocol
  (the `Restore` row)
- `clean-room-scope/features/feature-panels-ui.md` § Reconnect/restore, § TODO(verify) ("Terminal
