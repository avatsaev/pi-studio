...
## Scope references
- `clean-room-scope/architecture/design-system.md` § Colors (`colors.terminal` is "the full xterm
  theme (background/foreground/cursor/selection + 16 ANSI colors)"), § Scales
- `clean-room-scope/features/feature-panels-ui.md` § Terminal pane → Pi-Studio implementation contract
